...
export class CREATEDATABASE1743511992606 implements MigrationInterface {
    name = 'CREATEDATABASE1743511992606'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`workout_session\` (\`id\` int NOT NULL AUTO_INCREMENT, \`workoutId\` int NULL, \`startWorkout\` varchar(255) NOT NULL, \`endWorkout\` varchar(255) NOT NULL, \`duration\` varchar(255) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
