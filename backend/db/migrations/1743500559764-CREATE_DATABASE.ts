...
export class CREATEDATABASE1743500559764 implements MigrationInterface {
    name = 'CREATEDATABASE1743500559764'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`logged_set\` (\`id\` int NOT NULL AUTO_INCREMENT, \`weight\` int NOT NULL, \`rep\` int NOT NULL, \`setNumber\` int NOT NULL, \`workoutExerciseId\` int NULL, \`workoutSessionId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
