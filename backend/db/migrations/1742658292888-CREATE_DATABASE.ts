...
export class CREATEDATABASE1742658292888 implements MigrationInterface {
    name = 'CREATEDATABASE1742658292888'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`exercise\` (\`id\` varchar(255) NOT NULL, \`gifUrl\` varchar(255) NOT NULL, \`bodyPart\` varchar(255) NOT NULL, \`target\` varchar(255) NOT NULL, \`equipment\` varchar(255) NOT NULL, \`name\` varchar(255) NOT NULL, \`instruction\` json NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`workout_exercise\` (\`id\` int NOT NULL AUTO_INCREMENT, \`restTimeSecond\` int NOT NULL, \`setCount\` int NOT NULL, \`workoutId\` int NULL, \`exerciseId\` varchar(255) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
